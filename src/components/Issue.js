                ...
                >
                  <Paper>
                    <ClickAwayListener onClickAway={event => this.handleMenuClose(event, this.assigneeMenuAnchor, "assigneeMenuOpen")}>
                      <MenuList>
                        {this.state.issue.assignee.id !== this.props.keycloak.username() && (
                          <MenuItem style={styles.assigneeToMeButton} onClick={event => this.updateAssigneeReq(event, this.props.keycloak.username())}>
                            Assign to me
                          </MenuItem>
                        )}
